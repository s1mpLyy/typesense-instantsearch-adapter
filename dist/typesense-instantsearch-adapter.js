...
var Configuration = /*#__PURE__*/function () {
  function Configuration() {
     ...
     * }
     */
    this.queryEnhancement = (_options$queryEnhance = options.queryEnhancement) !== null && _options$queryEnhance !== void 0 ? _options$queryEnhance : {
      enabled: false,
...
var SearchRequestAdapter = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(SearchRequestAdapter, [{
    ...
    value: function () {
      var _buildSearchParameters2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee(instantsearchRequest) {
        var _this$configuration$c2, _this$configuration$s;
        var params, indexName, adaptedCollectionName, snakeCasedAdditionalSearchParameters, _i, _Object$entries, _Object$entries$_i, key, value, _i2, _Object$entries2, _Object$entries2$_i, _key, _value, typesenseSearchParams, adaptedSortBy, query, sortByOption;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              params = instantsearchRequest.params;
              indexName = instantsearchRequest.indexName;
              adaptedCollectionName = this._adaptIndexName(indexName); // Convert all common parameters to snake case
              snakeCasedAdditionalSearchParameters = {};
              for (_i = 0, _Object$entries = Object.entries(this.additionalSearchParameters); _i < _Object$entries.length; _i++) {
                _Object$entries$_i = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_Object$entries[_i], 2), key = _Object$entries$_i[0], value = _Object$entries$_i[1];
              ...
              if (this.collectionSpecificSearchParameters[adaptedCollectionName]) {
                for (_i2 = 0, _Object$entries2 = Object.entries(this.collectionSpecificSearchParameters[adaptedCollectionName]); _i2 < _Object$entries2.length; _i2++) {
                  _Object$entries2$_i = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_Object$entries2[_i2], 2), _key = _Object$entries2$_i[0], _value = _Object$entries2$_i[1];
              ...
              adaptedSortBy = this._adaptSortBy(indexName); // Use the query as provided (already enhanced if needed)
              query = params.query === "" || params.query === undefined ? "*" : params.query;
              ...
              return _context.abrupt("return", Object.fromEntries(Object.entries(typesenseSearchParams).filter(function (_ref2) {
      ...
      function _buildSearchParameters(_x) {
        return _buildSearchParameters2.apply(this, arguments);
      }
      return _buildSearchParameters;
    }()
  }, {
    ...
    key: "request",
    value: function () {
      var _request = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee2() {
        var _this4 = this,
          _searches$,
          _searches$2;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return Promise.all(this.instantsearchRequests.map(function (instantsearchRequest) {
            ...
            case 2:
              ...
              return _context2.abrupt("return", this.typesenseClient.multiSearch.perform({
                searches: searches
              }, commonParams));
            case 6:
            case "end":
...
var TypesenseInstantsearchAdapter = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(TypesenseInstantsearchAdapter, [{
    key: "_enhanceQuery",
    value: (function () {
      var _enhanceQuery2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee(query) {
    ...
    value: (function () {
      var _performQueryEnhancement2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee2(query) {
    ...
    value: function () {
      var _enhanceSearchRequests2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee4(instantsearchRequests) {
        var _this2 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              uniqueQueries = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(new Set(allQueries));
              ...
              enhancementPromises = uniqueQueries.map( /*#__PURE__*/function () {
                var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee3(query) {
                  var enhancedQuery;
    ...
    value: function () {
      var _searchTypesenseAndAdapt = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee5(instantsearchRequests) {
        var _this3 = this;
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 6:
              ...
              adaptedResponses = typesenseResponse.results.map(function (typesenseResult, index) {
                ...
                var responseAdapter = new _SearchResponseAdapter__WEBPACK_IMPORTED_MODULE_9__.SearchResponseAdapter(typesenseResult, instantsearchRequests[index],
    ...
    value: function () {
      var _searchTypesenseForFacetValuesAndAdapt = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee6(instantsearchRequests) {
        var _this4 = this;
        var typesenseResponse, enhancedRequests, adaptedResponses;
          ...
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 6:
              ...
              adaptedResponses = typesenseResponse.results.map(function (typesenseResult, index) {
                ...
                var responseAdapter = new _FacetSearchResponseAdapter__WEBPACK_IMPORTED_MODULE_10__.FacetSearchResponseAdapter(typesenseResult, instantsearchRequests[index],
                // Use original requests for response mapping
    ...
    value: function () {
      var _adaptAndPerformTypesenseRequest2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee7(instantsearchRequests) {
